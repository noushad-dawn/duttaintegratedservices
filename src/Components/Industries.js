...
const Industries = () => {
  ...
  useEffect(() => {
    Aos.init({ duration: 1000, once: true }); // Customize options if needed
  }, []);
    ...
    <div id="industries" className="flex flex-col items-center p-6 bg-background bg-div">
      ...
      <div className="md:w-5/6 p-4">
        <p className="text-white dark:text-gray-300 mb-4" data-aos="fade-up">
          We’re passionate about the industries we operate in. Armed with expert knowledge of their sector, our consultants
          fully appreciate the essential skills, qualities, and expertise candidates need to ensure our clients remain at
          the forefront of their industry.
          <br />
          <br />
          Each industry presents unique challenges and opportunities. Here at our company, we leverage our extensive
          experience to navigate these complexities, ensuring that we provide our clients with the highest level of service
          and expertise.
        </p>
      </div>
